...
| Couchbase Node | Espace de noms
Cluster
Nom d'hôte du nœud Couchbase | Nom du nœud
IP du nœud | Mémoire libre
Mémoire totale 


| Compartiment Couchbase | Espace de noms
Godet
Cluster | Nom du nœud
IP du nœud | Données utilisées
Fetches de données
Disque utilisé
Nombre d'éléments
Mémoire utilisée
